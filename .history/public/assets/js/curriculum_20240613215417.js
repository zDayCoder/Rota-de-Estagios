$(document).ready(function() {
    ...
    // Adicionar Idioma
    $('#addSkill').click(function() {
        let skillIndex = $('#skills .section').length + 1; // Começa com 1 ou ajusta conforme necessário
        ...
        let $newSkill = $(`
            <div class="section" id="skill_${skillIndex}">
                ...
                <label for="skill_level_${skillIndex}">Nível:</label>
                <span id="skill_level_text_${skillIndex}">Iniciante</span>
                <input type="text" id="skill_level_${skillIndex}" name="skill_levels[]"" class="w3-input w3-border">
                <div class="checkbox-label">
            <label for="beginner_${skillIndex}">Iniciante</label>
            <input type="checkbox" id="beginner_${skillIndex}" name="skill_levels[]" value="Iniciante">
          </div>
          <div class="checkbox-label">
            <label for="intermediate_${skillIndex}">Intermediário</label>
            <input type="checkbox" id="intermediate_${skillIndex}" name="skill_levels[]" value="Intermediário">
          </div>
          <div class="checkbox-label">
            <label for="advanced_${skillIndex}">Avançado</label>
            <input type="checkbox" id="advanced_${skillIndex}" name="skill_levels[]" value="Avançado">
          </div>
          <div class="checkbox-label">
            <label for="professional_${skillIndex}">Profissional</label>
            <input type="checkbox" id="professional_${skillIndex}" name="skill_levels[]" value="Profissional">
          </div>
          <div class="checkbox-label">
            <label for="expert_${skillIndex}">Especialista</label>
            <input type="checkbox" id="expert_${skillIndex}" name="skill_levels[]" value="Especialista">
          </div>
                <button type="button" class="removeButton" data-index="${skillIndex}" data-section="skill">Remover Habilidade</button>
            </div>
        `);
        ...
        $newSkill.find(`#skill_level_${skillIndex}`).on('input', function() {
            updateSkillText(skillIndex);
        });
    });
