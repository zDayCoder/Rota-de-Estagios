                            ...
                            <div class=" dados-basicos ">
                                <div class="row">
                                    <div class="col-xl-3 image-user" id="view_photo">
                                        {{-- <div class="img-thumbnail image-uploader" data-base-width="150"
                                            data-base-height="150"> --}}
                                            {{-- <div class="image">
        ...
        (function() {
            ...
            var UserImage = {
                ...
                handleImage: function(elt, file) {
                    UserImage.resizeImage(elt, file, elt.data('width'), elt.data('height'), function(data,
                        width, height) {
                ...
                zoom: function(elt, factor) {
                    var currentWidth, currentHeight, originalWidth, originalHeight, baseWidth, baseHeight,
                        currentZoom, posx, posy;
                    ...
                    if ((currentWidth >= originalWidth && currentHeight >= originalHeight && factor > 0) ||
                        currentZoom + factor < 0)
                        return;
                    ...
                    var currentWidth = imgRatio <= 1 ? baseWidth : Math.round(originalWidth * baseHeight /
                        originalHeight);
                    var currentHeight = imgRatio > 1 ? baseHeight : Math.round(originalHeight * baseWidth /
                        originalWidth);
