                    ...
                    <div class="w3-container">
                        ...
                        <form action="{{ route('curricula.store') }}" method="POST">
                            ...
                            <div class="dados-pessoais p-3 "">
                                ...
                                <div class="d-flex justify-content-between align-items-center conteudo-">
                                    <h3>Habilidades</h3><button type="button" id="addSkill"><span class="material-symbols-outlined align-items-center">
                                        add
                                        </span></button>
                                </div>
                                <div id="skills"></div>
