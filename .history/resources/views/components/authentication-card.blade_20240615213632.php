<style>
    ...
    color: #000000 !important; /* Altere a cor do texto conforme necessário */
    /* Adicione outros estilos conforme necessário */
    border: 1px solid #ccc; /* Exemplo de borda */
    transition: background-color 5000s ease-in-out 0s; /* Evita que o fundo volte para o estilo padrão após um curto período */
}
</style>
