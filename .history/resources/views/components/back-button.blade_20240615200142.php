<style>
    ...
    .arrow-svg {
        transition: 0.5s;
        width: 24px; /* Largura do ícone de seta */
        fill: white; /* Cor do ícone de seta */
    }
...
<div class="arrow-container" title="voltar" onclick="window.history.back()">
    <svg class="arrow-svg" xmlns="http://www.w3.org/2000/svg" fill="none" height="24" viewBox="0 0 24 24" width="24">
        <path d="M8.96216 6.34317L10.3731 7.76069L7.10283 11.0157L20.7079 11.0293L20.7059 13.0293L7.13814 13.0157L10.3533 16.2459L8.93571 17.6568L3.29211 11.9868L8.96216 6.34317Z"/>
    </svg>
</div>
