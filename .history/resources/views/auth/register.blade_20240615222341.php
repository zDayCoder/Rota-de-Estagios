<x-guest-layout>
    <x-authentication-card>
        ...
        <div class="regist-login-card" id="userTypeSelection">
            <h1>Selecione o Tipo de Usuário</h1>
            <div class="user-type-option" id="internOption">
                <input type="radio" name="user_type" value="Intern">
                <label for="internOption">Estagiário</label>
                <div class="user-type-description">Opção para estudantes em busca de oportunidades de estágio.</div>
            </div>
            <div class="user-type-option" id="enterpriseOption">
                <input type="radio" name="user_type" value="Enterprise">
                <label for="enterpriseOption">Empresa/Recrutador</label>
                <div class="user-type-description">Opção para empresas e recrutadores procurando candidatos.</div>
            </div>
        </div>
