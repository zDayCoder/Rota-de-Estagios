                ...
                @if ($tipoUser !== 'Coordinator')
                    <div id="userTypeSelection">
                        ...
                        <div class="user-type-option internn" id="internOption">
                            ...
                            <div class="user-type-description">Opção para estudantes em busca de oportunidades de
                                estágio.
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-end mt-4 button-register" id="nextButtonContainer">
